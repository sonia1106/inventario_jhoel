          ...
          <div class="col-md-12">
            ...
            <div class="card">
              ...
              <div class="card-footer clearfix">
                <a href="{{route('compras.create')}}" class="btn btn-sm btn-info float-left">Realizar Compra</a>
                <a href="{{route('insumos.listar')}}" class="btn btn-sm btn-secondary float-right">Listar Insumos</a>
              </div>
              <!-- /.card-footer -->
            </div>
            <!-- /.card -->

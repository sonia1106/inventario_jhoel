        ...
        <table class="table table-striped">
          <thead>
            <tr>
                ...
                <th>
                    <a href="{{ route('insumos.listar', ['sort' => 'fecha_ingreso', 'direction' => $nextDirection]) }}">
                        Fecha de Ingreso
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $insumo->precio_uni }}</td>
              <td>{{ $insumo->fecha_ingreso }}</td>
              <td>{{ $insumo->proveedor->nombre }}</td>
              <td>
                <a href="{{ route('insumos.editar', $insumo->id) }}" class="btn btn-block btn-warning btn-sm">
                  Editar
              </a>
              </td>
              <td>
                <form action="{{ route('insumos.eliminar', $insumo->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-danger" onclick="return confirm('¿Estás seguro de que deseas eliminar este insumo?');">Eliminar</button>
                </form>
            </td>
            </tr>
            @endforeach

                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="cantidad"  class="form-control" id="cantidad" placeholder="">
                                      </div>
                                </div>
                                <div class="col-md-3 col-sm-4">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">P/U</label>
                                        <input type="number" name="precio_uni"  class="form-control" id="precio_uni" placeholder="">

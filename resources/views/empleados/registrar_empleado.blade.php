        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-4">
              <div class="form-group">
                ...
                <input type="text" name="apellidos"  class="form-control" id="exampleInputEmail1" placeholder="Ingrese apellidos">
              </div>
            </div>
            <div class="col-md-3 col-sm-4">
              <div class="form-group">
                ...
                <select id="puesto" name="puesto" required class="form-control">
                  ...
                  <option value="Tecnico de produccion">Tecnico de Produccion</option>
                  <option value="Encargado compras">Encargado de compras</option>
            ...
            <div class="col-md-3 col-sm-4">
              <div class="form-group">
                ...
                <input type="number" name="edad" class="form-control" id="exampleInputEmail1" placeholder="">
              </div>
            </div>
            <div class="col-md-3 col-sm-4">
              <div class="form-group">
                <label for="exampleInputEmail1">Telefono</label>
                <input type="text" name="telefono" class="form-control" id="exampleInputEmail1" placeholder="Ingrese telefono">
              </div>
            </div>
            <div class="col-md-3 col-sm-4">
              <div class="form-group">
                <label for="exampleInputEmail1">Direccion</label>
                <input type="text" name="direccion" class="form-control" id="exampleInputEmail1" placeholder="Ingrese direccion">
              </div>
            </div>
            <div class="col-md-3 col-sm-4">
              <div class="form-group">
